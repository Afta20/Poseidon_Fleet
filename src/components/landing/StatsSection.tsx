...
const STATS = [
  {
    ...
    value: 120,
    suffix: '+',
    label: 'Kapal Terpantau',
    description: 'Armada aktif dimonitor',
  },
  {
    icon: <Route size={24} />,
    value: 340,
    suffix: '+',
    label: 'Rute Aktif',
    description: 'Jalur pelayaran tercatat',
  },
  {
    icon: <Clock size={24} />,
    value: 99,
    suffix: '%',
    label: 'Uptime Sistem',
    description: 'Keandalan platform',
  },
  {
    icon: <Anchor size={24} />,
    value: 15,
    suffix: '+',
    label: 'Pelabuhan',
    description: 'Titik operasi tersebar',
  },
];
